...
insert into recipe (id, nome, chef_id, main_image, extra_image1, extra_image2, extra_image3, procedure) values(nextval('recipe_seq'), 'Lasagne alla Bolognese', 301, null, null, null, '201Extra3.jpg', '_Prima linea\\nSeconda linea\\nTerza linea\\nQuarta linea');
